...
public class LeafGround_Buttons {
	...
	// Click on Image Button and Click on any hidden buttons
	    ...
	    // To find round of rounded buttons
	    
	    List<WebElement> findElements = driver.findElements(By.xpath("//h5[contains(text(),'How many rounded')]/following::button"));
	    int noOfButtons = findElements.size();
	    System.out.println("No of rounded buttons is  "+noOfButtons);
